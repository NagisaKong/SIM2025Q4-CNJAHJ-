...
class RequestController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('PIN/Boundary/requests/index.php', [
            'title' => 'My Requests',
            'requests' => $requests,
            'total' => $total,
            'page' => $page,
    ...
    {
        return $this->render('PIN/Boundary/requests/form.php', [
    ...
    public function show(int $id): Response
    {
        ...
        return $this->render('PIN/Boundary/requests/show.php', [
