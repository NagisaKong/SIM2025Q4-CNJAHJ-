...
class CategoryController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('Admin/Boundary/categories/index.php', [
    ...
    {
        return $this->render('Admin/Boundary/categories/form.php', [
    ...
    public function show(int $id): Response
    {
        ...
        return $this->render('Admin/Boundary/categories/show.php', [
